		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="container-fluid">
					<form method="POST" action="crud/crudXML/edit.php">
			...
			<div class="modal-footer">
				...
				<button type="submit" name="edit" class="btn btn-success"><span
						class="glyphicon glyphicon-check"></span> Modifier</button>
				</form>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<center>
					<h4 class="modal-title" id="myModalLabel">Supprimer définitivement </h4>
				</center>
			</div>
			<div class="modal-body">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-info" data-dismiss="modal"><span
						class="glyphicon glyphicon-remove"></span> Annuler</button>
				<a href="crud/crudXML/delete.php?id=<?php echo $row->id; ?>" class="btn btn-danger"><span

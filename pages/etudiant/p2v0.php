<!-- MEME VERSION A PLANNING MAIS SANS STYLE CSS -->
<?php
...
foreach ($students as $student) {
    ...
    if (date('H:i', $soutenance_time) > '16:20') {
    ...
    // comparer directement l'heure extraite de $soutenance_time avec les plages horaires spécifiques, indépendamment de la date
    if (date('H:i', $soutenance_time) >= '11:20' && date('H:i', $soutenance_time) < '14:00') {
